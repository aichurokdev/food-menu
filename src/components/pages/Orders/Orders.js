...
//   }, []);
  ...
  const handleDeleteOrder = (idx) => {
    const newOrder = orderWithImages.filter((el, index) => index !== idx)
    setOrderWithImages(newOrder);
  }
      ...
      <div className="container">
        <div className="orders">
          ...
          <div className="orders--blocks">
            {orderWithImages && orderWithImages.map((el, idx) => (
              <div key={idx} className="orders--blocks__block">
                ...
                <div className="orders--blocks__block--texts">
                  ...
                  <div className="orders--blocks__block--texts__btns">
                    <button className="orders--btn1" onClick={() => handleDeleteOrder(idx)}>delete order</button>
